...
.DESCRIPTION
    ...
    local MinIO dev stack (team-collections/dev/):
      ...
      1. One S3 bucket per environment (default: bloom-teams-production,
         ...
         team-collections/dev/docker-compose.yml's MinIO init job, which sets the identical
...
function Ensure-LifecycleRules {
    ...
    # Mirrors team-collections/dev/docker-compose.yml's minio-init job (which sets an equivalent
