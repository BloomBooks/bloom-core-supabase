...
//
// HOW TO RUN:
//   1. Start MinIO: docker compose -f team-collections/dev/docker-compose.yml up -d
//   2. dotnet run --project team-collections/dev/parity-check/ParityCheck.csproj
//
...
internal static class Program
{
    ...
    internal static async Task<int> Main(string[] args)
    {
        ...
        if (failed > 0)
        {
            ...
            Console.WriteLine("  Document any failures in team-collections/dev/DEV-CREDENTIALS.md");
