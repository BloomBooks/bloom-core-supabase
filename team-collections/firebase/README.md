...
reviewed reference, not code this repo builds, tests, or deploys.** The Bloom desktop client (the BloomDesktop
...
The local Supabase dev stack (`team-collections/dev/`) uses local GoTrue, not Firebase third-party auth,
