...
// team-collections/dev/DEV-CREDENTIALS.md) lives in exactly one place.
 ...
 * machine) rather than real AWS. Mirrors team-collections/dev/DEV-CREDENTIALS.md's
 ...
 * bloom-teams-broker role ARN it is allowed to assume (see team-collections/aws/provision-aws.ps1). */
